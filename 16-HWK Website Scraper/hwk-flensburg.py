...
import time
# Base URL to scrape
# base_url = "https://www.hwk-cottbus.de/kontakte/liste-7,0,dalist.html?curChar="
main_url = "https://www.hwk-flensburg.de"
csv_name="hwk-flensburg.xlsx"
main_list=[]
...
def download_and_parse_vcf(vcf_url):
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            soup = BeautifulSoup(position, "html.parser")
            clean_position = soup.get_text()
            return {
                'Name': name,
                'Email': email,
                'Phone': phone,
...
for char in string.ascii_uppercase:
    ...
    # url = base_url + char
    url=f"https://www.hwk-flensburg.de/kontakte/liste-11,0,dalist.html?curChar={char}"
