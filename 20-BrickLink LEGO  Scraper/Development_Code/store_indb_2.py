#Complete code which store Main Page Content,Table Content,Consist_Of Content And Download Image
# This Code is For Sets And Manifugres
import os
import re
import json
import requests
...
def process_item(item_no):
    ...
    while attempt < max_retries:
        ...
        try:
            ...
            consist_of_url = f"https://www.bricklink.com/catalogItemInv.asp?{catType}={item_no}"
